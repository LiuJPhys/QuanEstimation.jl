...
function test_Lindblad_MeasurementOpt()
    ...
    opts = [
        QuanEstimationBase.MeasurementOpt(; mtype = :Projection),
        QuanEstimationBase.MeasurementOpt(; mtype = :LC, POVM_basis = POVM_basis),
        QuanEstimationBase.MeasurementOpt(; mtype = :Rotation, POVM_basis = POVM_basis),
    ]
